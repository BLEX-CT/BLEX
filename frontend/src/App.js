...
export default function App() {
  ...
  useEffect(()=>{if(flags.promo_banners===false||!filteredFinal.length)return;filteredFinal.forEach((_,idx)=>{if(idx>0&&idx%BANNER_INTERVAL===0){const bi=Math.floor(idx/BANNER_INTERVAL)-1;const b=PROMO_BANNERS[bi%PROMO_BANNERS.length];trackBView('infeed_'+b.id);}});},[filteredFinal.length,flags.promo_banners,category]);// eslint-disable-line
  ...
  return (
    ...
    {view==="product"&&selectedProduct&&(()=>{
      ...
      return(<div className="fu" style={{maxWidth:"480px",margin:"0 auto",paddingBottom:"110px",position:"relative"}}>
        {/* HERO GALLERY */}
